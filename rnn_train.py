...
basedir = "/240gb/"
# shakedir = basedir + "shakespeare/*.txt"
shakedir = basedir + "datasets/jokes.txt"
# encoding: UTF-8
...
# shakedir = "training_data/lyrics.csv"
...
summary_writer = tf.summary.FileWriter(basedir + "log/" + timestamp + "-training")
validation_writer = tf.summary.FileWriter(basedir + "log/" + timestamp + "-validation")
...
for x, y_, epoch in txt.rnn_minibatch_sequencer(codetext, BATCHSIZE, SEQLEN, nb_epochs=10):
    ...
    if step // 10 % _50_BATCHES == 0:
        saved_file = saver.save(sess, basedir + 'checkpoints/rnn_train_' + timestamp, global_step=step)
